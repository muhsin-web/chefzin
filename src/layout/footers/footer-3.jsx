...
const footer_contents = {
  ...
  footer_widgets: [
    {
      ...
      title: 'Useful Links',
      widget_lists: ['Contact us', 'Our Menu', 'Explore', 'Terms & Services', 'Privacy and Policy']
    },
    {
      padd: 'pl-20',
      title: 'Community',
  ...
  copy_right_text: <>© Copyright ©{new Date().getFullYear()} Chefzin. All Rights Reserved Copyright</>,
