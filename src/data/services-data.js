...
const services_data = [
  ...
  // home three
  {
    ...
    title:'Book/Hire a chef',
    color:'service-color-1',
    text_1:'Select the best booking plan for you next share your special moment, budget, event details and meal preference. A chef will be sent with all requirements including groceries',
    home_3:true,
    service_p_4:true,
  },
  {
    ...
    title:'Culinary arts Education',
    color:'service-color-2',
    text_1:'Become a culinary expert: sign up to our online professional culinary school',
    home_3:true,
    service_p_4:true,
  },
  // {
